...
contextBridge.exposeInMainWorld('api', {
  ...
  setDragMode: (isDragging) => ipcRenderer.send('set-drag-mode', isDragging),
  mergeTabs: (data) => ipcRenderer.send('merge-tabs', data),
  setSplitRatio: (data) => ipcRenderer.send('set-split-ratio', data),
  closePane: (data) => ipcRenderer.send('close-pane', data),
  repositionPane: (data) => ipcRenderer.send('reposition-pane', data),
  ...
  onUrlUpdated: (callback) => ipcRenderer.on('url-updated', (_event, url) => callback(url)),
  onSyncDividers: (callback) => ipcRenderer.on('sync-dividers', (_event, dividers) => callback(dividers)),
